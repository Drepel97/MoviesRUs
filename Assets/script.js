...
searchButton.addEventListener("click", function(){
    ...
    getIMDB_ID_ByTitle(searchBar.value)
    
})

function getIMDB_ID_ByTitle(title){
    fetch(`https://imdb-api.com/en/API/SearchMovie/${imdbKey}/` + title)
...
recentlySearched.addEventListener("click", function(event){
    if(event.target.matches("button")) {
        ...
        streamingDataEl.innerHTML ="";
        reviewEl.innerHTML = ""
        getIMDB_ID_ByTitle(event.target.textContent)
